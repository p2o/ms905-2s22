...
`Data de entrega`: **30/08, 2022 às 23:59**
...
function create_bar()
    bar = zeros(Float64, 100)
	bar[41:60] = ones(Float64, 20)
    return bar
end
...
value_as_color.(get_reds(apolo_head))
...
# ╔═╡ 77758a23-989a-4b6d-a656-6e49cd71014f
function get_greens(image::AbstractMatrix)
    return get_green.(image)
end

# ╔═╡ 99532be3-120c-4001-bcd8-86741ec8a0a8
function get_blue(pixel::AbstractRGB)
    return pixel.b
end

# ╔═╡ 9805b6ea-7813-4b8b-8281-ef6eeb3fcda8
function get_blues(image::AbstractMatrix)
    return get_blue.(image)
end

# ╔═╡ 5b527d6a-1f89-41d4-80b8-1cf9d5e09955
function value_as_color_green(x)
    return RGB(0, x, 0)
end

# ╔═╡ 586c195f-ab62-46be-ac7d-aabcfaf90fff
value_as_color_green.(get_greens(apolo_head))

# ╔═╡ ea35dffd-e010-4298-b2f1-adaed1efd214
function value_as_color_blue(x)
    return RGB(0, 0, x)
end

# ╔═╡ 343807b9-8c57-4702-a5df-0c71306aae56
value_as_color_blue.(get_greens(apolo_head))
...
function invert(color::AbstractRGB)
    return RGB(1,1,1) - color
end

# ╔═╡ 2cc2f84e-ee0d-11ea-373b-e7ad3204bb00
md"Vamos inverver algumas cores:"
...
function noisify(x::Number, s)
    return clamp(rand(x-s:10e-5:x+s), 0.0, 1.0)
end
...
@bind apolo_noise Slider(0:0.01:10, show_value=true)
...
A imagem se torna irreconhecível com a partir da intensidade 2
"""
...
Lembre que, em Julia, as imagens são matrizes de objetos `RGB` que represetam cores.
